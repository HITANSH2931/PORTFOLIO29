    ...
    <section id="about" className='mx-5 md:mx-20 lg:mx-40 mt-60'>
      ...
      <img src={image} className='w-lg h-72 rounded-lg bg-linear-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63]'/>
        <div className='flex flex-col gap-5'>
          ...
          <h2 className='text-white  font-semibold text-2xl'>Front End Developer</h2>
          <p className='text-gray-300 text-[15px]'>
           Frontend Developer specializing in React.js, Redux, and Tailwind CSS, backed by strong expertise in Spring Boot, Microservices, and Docker. Skilled in building dynamic user interfaces and integrating secure, production-ready backend services for robust applications.
          </p> 
       ...
       <div className='mt-20 flex flex-col gap-3.5'>
        ...
        <p className='text-gray-300 text-[15px]'>I am a Front End Developer from Dehradun, Uttarakhand, with a strong interest in building efficient, high-performance web applications. I specialize in creating end-to-end solutions and enjoy working with modern technologies.</p>
